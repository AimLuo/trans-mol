...
import { ArrowDropDownSvg, ArrowRightSvg, Icon } from './controls/icons'

export const PluginReactContext = React.createContext(
  void 0 as any as PluginUIContext
)

export abstract class PluginUIComponent<
  P = {},
  S = {},
  SS = {}
...
export abstract class PurePluginUIComponent<
  P = {},
  S = {},
  SS = {}
...
export type _Props<C extends React.Component> = C extends React.Component<
  infer P
>
  ? P
  : never
export type _State<C extends React.Component> = C extends React.Component<
  any,
  infer S
>
  ? S
...
export abstract class CollapsableControls<
  P = {},
  S = {},
  SS = {}
> extends PluginUIComponent<P & CollapsableProps, S & CollapsableState, SS> {
  toggleCollapsed = () => {
    this.setState({ isCollapsed: !this.state.isCollapsed } as S &
      CollapsableState)
  }
