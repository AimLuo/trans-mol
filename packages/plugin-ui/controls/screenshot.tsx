...
import { shallowEqual } from 'molstar/lib/mol-util/object'
...
export const ScreenshotPreview = React.memo(_ScreenshotPreview, (prev, next) =>
...
function drawPreview(
  helper: ViewportScreenshotHelper,
...
function ViewportFrame({
  ...
  useBehavior(
    params?.resolution.name === 'viewport' ? plugin.canvas3d?.resized : void 0
  )
