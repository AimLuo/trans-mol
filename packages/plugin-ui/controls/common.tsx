...
export class TextInput<T = string> extends React.PureComponent<
  TextInputProps<T>,
  TextInputState
> {
  ...
  onChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const isInvalid =
      (this.props.isValid && !this.props.isValid(value)) ||
    ...
    if (this.props.numeric) {
      ...
      this.setState({ value: formatted }, () =>
        this.triggerChanged(formatted, converted)
      )
    }
  }
  ...
  render() {
    return (
      <input
        ...
        onKeyPress={
          this.props.onEnter ||
          this.props.blurOnEnter ||
          this.props.blurOnEscape
            ? this.onKeyPress
            : void 0
        }
    ...
    return (
      <>
        <div
          ...
          style={{
            marginTop:
              this.props.marginTop !== void 0 ? this.props.marginTop : '1px',
        ...
        {this.state.isExpanded &&
          (this.props.noOffset ? (
            ...
            <div
              className={
                this.props.accent ? 'msp-accent-offset' : 'msp-control-offset'
              }
            >
              {this.props.children}
            </div>
...
export function ControlRow(props: ControlRowProps) {
  ...
  return (
    <div className={className}>
      <span className='msp-control-row-label' title={props.title}>
        {props.label}
      </span>
