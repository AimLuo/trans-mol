...
export function Icon(props: {
  ...
  return (
    <span
      className={`msp-icon msp-material-icon${
        props.inline ? ' msp-icon-inline' : ''
      }`}
      title={props.title}
      style={props.style}
    >
...
const circleLeft = (
  <circle r='6px' id='circle-left' cy='12px' cx='8px' strokeWidth='1px' />
)
const circleRight = (
  <circle r='6px' id='circle-right' cy='12px' cx='16px' strokeWidth='1px' />
)
