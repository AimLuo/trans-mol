...
import { State, StateAction, StateTransform } from 'molstar/lib/mol-state'
...
class ApplyActionControl extends TransformControlBase<
  ApplyActionControl.Props,
  ApplyActionControl.ComponentState
> {
  applyAction() {
  ...
  private _getInfo = memoizeLatest((t: StateTransform.Ref, v: string) =>
  ...
  static getDerivedStateFromProps(
    ...
    const params = props.action.definition.params
      ? PD.getDefaultValues(
          props.action.definition.params(source, state.plugin)
        )
      : {}
