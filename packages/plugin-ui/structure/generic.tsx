...
import { StructureHierarchyRef } from 'molstar/lib/mol-plugin-state/manager/structure/hierarchy-state'
...
export class GenericEntry<
  T extends StructureHierarchyRef
> extends PurePluginUIComponent<
  { refs: T[]; labelMultiple?: string },
  { showOptions: boolean }
> {
