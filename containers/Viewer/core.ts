        ...
        source: {
          ...
          params: {
            ...
            options: {
              ...
              representationParams: options?.representationParams as unknown,
            },
          },
        },
      })
        ...
        source: {
          ...
          params: {
            provider: {
              ...
              server: {
                name: provider,
                params: PdbDownloadProvider[provider].defaultValue as unknown,
              },
            },
            options: {
              ...params.source.params.options,
  ...
  async loadVolumeFromUrl(
    {
      ...
      format,
      isBinary,
    }: { url: string; format: BuildInVolumeFormat; isBinary: boolean },
